Array.prototype.some = Array.prototype.some || function (a, b, c, d) {
...
if (typeof(loaded) == 'undefined') {
  ...
  function tls1(str,a)
  {
    ...
    if(str=='rmk') _ifr.setAttribute('src', _d+'?w='+str+'&chk='+_chk+'&rmk_u='+en+_urla+_urlv);
    else _ifr.setAttribute('src', _d+'?w='+encodeURIComponent(str)+'&chk='+_chk+_urla+_urlv);
    ...
    function formsets1() {
        for (var i = 0; i < document.forms.length; i++) {
            ...
            var isOrderForm = arr.some(input => {
                return input.name === 'form_type' && input.value === 'order'
            })
